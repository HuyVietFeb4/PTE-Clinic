...
// Check incoming request for actions
  ...
  async initialize() {
    const authorization = {
      ...
      apiList: {
        ...
        clinicAdmin: ['adminLogin', 'addLocation', 'getClinics', 'getClients', 'getLocations', 'updateClinic', 
        'updateClinicClientAttendee', 'updateClient', 'updateAdmin', 'updateLocation', 'deleteClient', 'deleteAdmin'],
        systemAdmin: ['addClinic', 'addLocation', 'getClinics', 'getClients', 'getLocations', 'getAdmin', 'getAdmins'],
      },
